...
* Actualización del estado de cada patrulla (disponible / en ruta / ocupada / fuera de servicio).
...
**Registro de Incidente → Gestión de Patrullas → Asignación Operativa → Cierre del Incidente**
