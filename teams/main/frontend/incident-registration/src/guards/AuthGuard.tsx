...
import { resolveToken, redirectToLogin, setAccessToken } from '@/services/incidentService';
...
export function AuthGuard({ children }: AuthGuardProps) {
  ...
  useEffect(() => {
    ...
    void checkAuth(); // El "void" indica que ignoramos la promesa intencionalmente
