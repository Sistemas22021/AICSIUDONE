 ...
 * - Visualizar el estado de autenticación (SSO).
 */
import { getAccessToken } from '@/services/incidentService';
...
export function WelcomePage() {
  ...
  return (
    <div className="min-h-screen bg-[#020617] text-slate-200 relative overflow-hidden">
      ...
      {/* Fondo Mesh sutil */}
      <div className="absolute top-0 right-0 w-125 h-125 bg-indigo-500/10 rounded-full blur-[120px]" />
      <div className="absolute bottom-0 left-0 w-125 h-125 bg-purple-500/10 rounded-full blur-[120px]" />
        ...
        <header className="flex flex-col md:flex-row md:items-center justify-between gap-8 mb-16 animate-fade-in">
          <div>
            ...
            <h1 className="text-5xl font-bold text-white tracking-tight mb-4">
              Hola de nuevo, <span className="text-transparent bg-clip-text bg-linear-to-r from-indigo-400 to-violet-400">{username}</span>
            </h1>
          ...
          {/* Avatar / User Card */}
          <div className="satin-glass p-6 rounded-4xl flex items-center gap-4 border-white/5 shadow-2xl">
            <div className="w-14 h-14 bg-linear-to-tr from-indigo-600 to-violet-500 rounded-2xl flex items-center justify-center text-white text-xl font-bold shadow-lg">
              ...
              <div className="relative pl-8 border-l-2 border-white/5 space-y-10">
                {[
                  ...
                  <div key={i} className="relative group">
                    <div className="absolute -left-10.25 top-1 w-4 h-4 rounded-full bg-slate-900 border-2 border-indigo-500 group-hover:bg-indigo-500 transition-colors duration-300" />
