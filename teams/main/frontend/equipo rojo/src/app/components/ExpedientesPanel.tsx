...
import {
  ...
  ChevronUp, ChevronDown, Dot, Brain,
} from 'lucide-react'
...
interface ExpedientesPanelProps {
  isOpen:  boolean
  onClose: () => void
  /** Abre el expediente en el módulo B — Escena y Evidencia */
  onAbrirExpediente?: (expediente: ExpedienteActivo) => void
  /** Abre el expediente en el módulo C — Inteligencia IA / Modus Operandi, para registrar su firma conductual */
  onAbrirFirmaConductual?: (expediente: ExpedienteActivo) => void
}
                          ...
                          <td className="py-3 px-3">
                            <div className="flex items-center justify-center gap-1.5">
                              <button
                                  ...
                                  title="Abrir en Escena y Evidencia"
                              ...
                              {onAbrirFirmaConductual && (
                                  <button
                                      onClick={() => onAbrirFirmaConductual?.(exp)}
                                      title="Registrar Firma Conductual del Caso"
                                      className="p-1.5 border border-cyan-400/40 rounded-sm text-cyan-400 hover:bg-cyan-400/15 hover:border-cyan-400 hover:text-cyan-300 transition-all"
                                      style={{ boxShadow: '0 1px 4px rgba(51,153,255,0.15)' }}
                                  >
                                    <Brain size={12} />
                                  </button>
