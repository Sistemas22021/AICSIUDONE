...
import { LayoutDashboard, FileText, Mic2, Shield, Settings, CpuIcon, History } from 'lucide-react'
...
const navItems: NavItem[] = [
  ...
  { icon: <CpuIcon size={20} />, label: 'Procesamiento de Datos', id: 'data-extraction' },
]
